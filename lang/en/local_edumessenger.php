...
$string['settings:debug'] = 'Debug information';
$string['settings:debug:description'] = 'If enabled we will log many information for debugging to the apache error_log. Use with caution!';
